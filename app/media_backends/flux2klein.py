...
Final output: a photorealistic, high dynamic range (HDR), cinema-quality photograph. A photo that is sharp, clean, and rich in detail, with every element rendered with professional photographic precision. Recovered highlights retain texture and form, avoiding flat white or clipped pixels. A photo achieving a balanced, visually compelling image with full tonal fidelity. Preserve text details. Preserve facial structure. {}""".format(
                final_prompt
            )
